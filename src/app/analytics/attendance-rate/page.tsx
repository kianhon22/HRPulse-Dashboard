...
const mockTableData = [
  { department: "HR", rate: 97, count: 400 },
  { department: "Engineering", rate: 99, count: 600 },
  { department: "Sales", rate: 96, count: 300 },
];
          ...
          <div className="h-[300px]">
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={mockChartData} margin={{ top: 5, right: 30, left: 20, bottom: 30 }}>
                ...
                <YAxis domain={[0, 100]} label={{ value: "Attendance Rate (%)", angle: -90, dx: -20 }} />
                <Tooltip formatter={v => `${v}%`} />
                <Line type="linear" dataKey="rate" name="Attendance Rate (%)" stroke="#6A1B9A" strokeWidth={2} activeDot={{ r: 8 }} />
              </LineChart>
            </ResponsiveContainer>
          </div>
        </CardContent>
